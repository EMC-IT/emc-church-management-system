...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  [ROLES.ADMIN]: [
    ...
    'activity-logs.view', 'activity-logs.filter',
    ...
    'groups.view', 'groups.create', 'groups.edit', 'groups.categories', 'groups.members', 'groups.events', 'groups.roles', 'groups.attendance', 'groups.reports',
    'departments.view', 'departments.create', 'departments.edit', 'departments.categories', 'departments.members', 'departments.roles', 'departments.meetings',
    'sunday-school.view', 'sunday-school.classes.view', 'sunday-school.students.view', 'sunday-school.teachers.view', 'sunday-school.materials.view', 'sunday-school.attendance', 'sunday-school.reports',
    ...
    'events.view', 'events.create', 'events.edit', 'events.calendar', 'events.categories', 'events.templates', 'events.registrations', 'events.attendance', 'events.groups', 'events.bulk', 'events.export',
    'assets.view', 'assets.create', 'assets.edit', 'assets.categories', 'assets.reports', 'assets.export',
    ...
    'settings.view', 'settings.church-profile', 'settings.branches.view', 'settings.users.view', 'settings.roles.view',
    'profile.view', 'profile.edit', 'profile.security',
  ],
  [ROLES.PASTOR]: [
    'dashboard.view', 'analytics.view', 'analytics.attendance', 'analytics.demographics',
    'members.view', 'members.contact', 'members.converts', 'members.family', 'members.history',
    'attendance.view', 'attendance.history', 'attendance.reports',
    'groups.view', 'groups.members', 'groups.reports',
    ...
    'prayer-requests.view', 'prayer-requests.view-confidential', 'prayer-requests.create', 'prayer-requests.edit', 'prayer-requests.respond', 'prayer-requests.assign', 'prayer-requests.status',
    'events.view', 'events.create', 'events.edit', 'events.calendar', 'events.attendance',
    'communications.view', 'communications.messages', 'communications.announcements', 'communications.newsletters', 'communications.send',
    'profile.view', 'profile.edit', 'profile.security',
  ],
  [ROLES.ACCOUNTANT]: [
    'dashboard.view', 'analytics.view', 'analytics.finance', 'analytics.export',
  ...
  [ROLES.SECRETARY]: [
    'dashboard.view',
    'members.view', 'members.create', 'members.edit', 'members.import', 'members.export', 'members.contact', 'members.family', 'members.documents',
    'attendance.view', 'attendance.take', 'attendance.qr', 'attendance.history', 'attendance.reports',
    'groups.view', 'groups.members',
    'departments.view', 'departments.members', 'departments.meetings',
    'events.view', 'events.create', 'events.edit', 'events.calendar', 'events.registrations', 'events.attendance',
    'communications.view', 'communications.messages', 'communications.announcements', 'communications.newsletters', 'communications.send',
  ...
  [ROLES.TEACHER]: [
    'dashboard.view',
    'sunday-school.view', 'sunday-school.classes.view', 'sunday-school.students.view', 'sunday-school.students.manage', 'sunday-school.teachers.view', 'sunday-school.materials.view', 'sunday-school.attendance', 'sunday-school.reports',
    'members.view',
