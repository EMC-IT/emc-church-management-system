...
export const metadata: Metadata = {
  title: 'Ministries | Empowerment Mountain Church',
  description: 'Explore the vibrant ministries, life groups, and community outreach programs at Empowerment Mountain Church.',
};
    ...
    <main className="min-h-screen flex flex-col justify-between">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-center flex-grow flex flex-col justify-center items-center">
        ...
        <p className="font-body text-[#475569] text-lg sm:text-xl max-w-2xl mt-6 leading-relaxed">
          From children and youth ministries to life groups, worship, and community outreaches — discover a place where you belong.
        </p>
      </section>
    </main>
  );
