...
export const metadata: Metadata = {
  title: 'Sermons & Messages | Empowerment Mountain Church',
  description: 'Watch, listen to, and download messages and sermons from Empowerment Mountain Church.',
};
    ...
    <main className="min-h-screen flex flex-col justify-between">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-center flex-grow flex flex-col justify-center items-center">
        ...
        <p className="font-body text-[#475569] text-lg sm:text-xl max-w-2xl mt-6 leading-relaxed">
          Access anointed sermons, spiritual teachings, and inspirational messages to equip and empower your faith walk.
        </p>
      </section>
    </main>
  );
